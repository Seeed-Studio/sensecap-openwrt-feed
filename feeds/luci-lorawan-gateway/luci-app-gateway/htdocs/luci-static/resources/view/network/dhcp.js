...
return view.extend({
	...
	render: function(hosts_duids_pools) {
		...
		return m.render().then(function(mapEl) {
			...
			// Hide unwanted tabs
			var tabsToHide = ["cache", "devices", "dnsrecords", "dnssecopt", "filteropts", "limits", "files", "leases", "ipsets", "relay"];
			tabsToHide.forEach(function(tabName) {
				var tab = mapEl.querySelector('[data-tab="' + tabName + '"]');
				if (tab) tab.style.display = "none";
				var tabTitle = mapEl.querySelector('[data-tab-title="' + tabName + '"]');
