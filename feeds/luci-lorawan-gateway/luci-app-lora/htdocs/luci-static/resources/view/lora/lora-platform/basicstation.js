...
return view.extend({
    view: function () {
        ...
        if (!document.getElementById('basicstation-sfu-style')) {
            ...
            style.textContent = '.sfu-container{border-radius:10px;padding:16px}.sfu-dropzone{border:2px dashed var(--sensecap-dropzone-border);border-radius:6px;padding:16px;text-align:center;cursor:pointer;transition:border-color 0.2s,background-color 0.2s}.sfu-dropzone:hover{border-color:var(--primary);background:var(--sensecap-dropzone-hover-bg)}.sfu-dropzone.has-file{border-style:solid;border-color:var(--primary)}.sfu-text{color:var(--sensecap-muted-fg);font-size:15px}.sfu-dropzone.has-file .sfu-text{color:var(--sensecap-emphasis-fg);font-weight:500}.sfu-buttons{display:flex;justify-content:flex-end;gap:10px;margin-top:14px;padding-top:14px;border-top:1px solid var(--sensecap-divider)}.sfu-btn-remove,.sfu-btn-upload{color:#fff!important;background:var(--sensecap-neutral-btn-bg);border:none!important;padding:6px 20px;border-radius:4px;font-size:14px;cursor:pointer}.sfu-btn-upload:hover,.sfu-btn-remove:hover{background:var(--sensecap-neutral-btn-bg-hover)}';
