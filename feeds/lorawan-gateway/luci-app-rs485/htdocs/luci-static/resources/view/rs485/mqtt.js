...
return view.extend({
    ...
    render: function() {
        ...
        o = s.option(form.Flag, "mqtt_enabled", _("Enable MQTT Bridge"));
        o.rmempty = false;
        o.default = "0";
        ...
        o = s.option(form.ListValue, "mqtt_transport", _("Transport Protocol"));
        o.value("tcp", "TCP");
        o.value("ssl", "SSL/TLS");
        ...
        o = s.option(form.Value, "mqtt_keepalive", _("Keep Alive (seconds)"));
        ...
        o = s.option(form.ListValue, "mqtt_baudrate", _("Baudrate"));
        o.value("110", "110");
        o.value("300", "300");
        o.value("600", "600");
        o.value("1200", "1200");
        ...
        o = s.option(form.ListValue, "mqtt_databit", _("Data Bits"));
        o.value("5", "5");
        o.value("6", "6");
        o.value("7", "7");
        o.value("8", "8");
        ...
        o = s.option(form.ListValue, "mqtt_stopbit", _("Stop Bits"));
        o.value("1", "1");
        o.value("1.5", "1.5");
        o.value("2", "2");
        o.default = "1";
        ...
        o = s.option(form.ListValue, "mqtt_checkbit", _("Parity"));
        o.value("none", _("None"));
        o.value("odd", _("Odd"));
        o.value("even", _("Even"));
        o.value("mark", _("Mark"));
        ...
        o = s.option(form.TextValue, "mqtt_ca_cert", _("CA Certificate"));
        o.rows = 6;
        o.wrap = "off";
        o.optional = true;
        ...
        o = s.option(form.TextValue, "mqtt_client_cert", _("Client Certificate"));
        o.rows = 6;
        o.wrap = "off";
        o.optional = true;
        o.depends("mqtt_auth_mode", "mutual-tls");
        ...
        o = s.option(form.TextValue, "mqtt_client_key", _("Client Private Key"));
        o.rows = 6;
        o.wrap = "off";
        o.optional = true;
        o.depends("mqtt_auth_mode", "mutual-tls");
        ...
        o = s.option(form.DynamicList, "mqtt_event_topics", _("Additional Event Topics"));
        ...
        o = s.option(form.Flag, "mqtt_retain_status", _("Retain Status Messages"));
        o.default = "0";
        o.cfgvalue = function(section_id) {
        ...
        o = s.option(form.Value, "mqtt_reconnect_delay", _("Reconnect Delay (seconds)"));
        ...
        o = s.option(form.TextValue, "mqtt_notes", _("Maintenance Notes"));
        o.rows = 4;
